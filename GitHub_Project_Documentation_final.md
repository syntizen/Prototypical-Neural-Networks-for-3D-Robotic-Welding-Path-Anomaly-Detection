...
We model the physical kinematics of an industrial 6-DOF manipulator using Denavit-Hartenberg (DH) parameters. The homogeneous coordinate transformation mapping Frame <img src="https://latex.codecogs.com/png.image?\dpi{110}i-1" alt="i-1" style="vertical-align:middle"/> to Frame <img src="https://latex.codecogs.com/png.image?\dpi{110}i" alt="i" style="vertical-align:middle"/> is formulated as:

<img src="https://latex.codecogs.com/png.image?\dpi{110}T_i%5E%7Bi-1%7D%3D%5Cbegin%7Bbmatrix%7D%5Ccos%5Ctheta_i%26-%5Csin%5Ctheta_i%5Ccos%5Calpha_i%26%5Csin%5Ctheta_i%5Csin%5Calpha_i%26a_i%5Ccos%5Ctheta_i%5C%5C%5Csin%5Ctheta_i%26%5Ccos%5Ctheta_i%5Ccos%5Calpha_i%26-%5Ccos%5Ctheta_i%5Csin%5Calpha_i%26a_i%5Csin%5Ctheta_i%5C%5C0%26%5Csin%5Calpha_i%26%5Ccos%5Calpha_i%26d_i%5C%5C0%260%260%261%5Cend%7Bbmatrix%7D" alt="DH transformation matrix" style="vertical-align:middle"/>
...
<img src="https://latex.codecogs.com/png.image?\dpi{110}T_b%5E0%3DT_1%5E0%5Ccdot%20T_2%5E1%5Ccdot%20T_3%5E2%5Ccdot%20T_4%5E3%5Ccdot%20T_5%5E4%5Ccdot%20T_6%5E5" alt="Forward kinematics product" style="vertical-align:middle"/>
...
We synthesize 20 different normal operating scenarios (NUM\_SCENARIOS \= 20), generating 100 sample passes per scenario to compile a normal training dataset of 2,000 trajectories. Each trajectory has a sequence length of TIMESTEPS \= 128 over 3-dimensional Cartesian space coordinates <img src="https://latex.codecogs.com/png.image?\dpi{110}%28X%2CY%2CZ%29" alt="(X,Y,Z)" style="vertical-align:middle"/>.
...
During episodic metric training, the network is constrained to optimize relative spatial distances. Within each training episode (8-way 5-shot), the class prototypes <img src="https://latex.codecogs.com/png.image?\dpi{110}c_n" alt="c_n" style="vertical-align:middle"/> are computed as the support set mean embeddings:

<img src="https://latex.codecogs.com/png.image?\dpi{110}c_n%3D%5Cfrac%7B1%7D%7B%7CS_n%7C%7D%5Csum_%7Bx%5Cin%20S_n%7Df_%5Cphi%28x%29" alt="Prototype formula" style="vertical-align:middle"/>

The probability distribution for a query sample <img src="https://latex.codecogs.com/png.image?\dpi{110}q" alt="q" style="vertical-align:middle"/> across all classes is optimized using Euclidean metrics in the latent space:

<img src="https://latex.codecogs.com/png.image?\dpi{110}p%28y%3Dn%5Cmid%20q%29%3D%5Cfrac%7B%5Cexp%28-%5C%7Cf_%5Cphi%28q%29-c_n%5C%7C_2%5E2%29%7D%7B%5Csum_%7Bn%27%7D%5Cexp%28-%5C%7Cf_%5Cphi%28q%29-c_%7Bn%27%7D%5C%7C_2%5E2%29%7D" alt="Probability distribution formula" style="vertical-align:middle"/>
...
When testing a query trajectory <img src="https://latex.codecogs.com/png.image?\dpi{110}x_%7B%5Cmathrm%7Btest%7D%7D" alt="x_test" style="vertical-align:middle"/>, its anomaly score <img src="https://latex.codecogs.com/png.image?\dpi{110}A%28x_%7B%5Cmathrm%7Btest%7D%7D%29" alt="A(x_test)" style="vertical-align:middle"/> is the Euclidean distance to the nearest normal prototype:

<img src="https://latex.codecogs.com/png.image?\dpi{110}A%28x_%7B%5Cmathrm%7Btest%7D%7D%29%3D%5Cmin_%7Bn%5Cin%5C%7B1%2C%5Cldots%2C20%5C%7D%7D%5C%7Cf_%5Cphi%28x_%7B%5Cmathrm%7Btest%7D%7D%29-c_n%5C%7C_2" alt="Anomaly score formula" style="vertical-align:middle"/>
...
* **ROC Curve (Right):** The system achieves outstanding classification performance with a high Area Under the Curve value (<img src="https://latex.codecogs.com/png.image?\dpi{110}%5Cmathrm%7BAUC%7D%5Capprox%200.97" alt="AUC approx 0.97" style="vertical-align:middle"/>).
